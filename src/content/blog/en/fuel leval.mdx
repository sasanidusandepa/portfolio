...
tags: ["Arduino"]
cover: "./2023_02_07_12_46_IMG_1758.jpg"
---
#Introduction
...
The HC-SR04 ultrasonic sensor emits an ultrasonic pulse that bounces off the fuel surface and returns.
The time taken for the pulse to return is converted into a distance measurement (fuel height).
